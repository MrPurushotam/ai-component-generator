const SYSTEM_PROMPT = {
    ...
    IMPORTANT RULES:
    - Return ONLY these two code blocks
    - Use exactly the headers "### JSX" and "### CSS"
    - NO explanatory text before, after, or between code blocks
